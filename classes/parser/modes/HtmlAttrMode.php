...
use megabike\templates\parser\tokens\HtmlAttrToken;

class HtmlAttrMode extends Mode
{
    ...
    public function start(ParserStatus $status)
    {
        ...
        $token = new HtmlAttrToken($index, $attrName);
    ...
    protected function onEq(ParserStatus $status, $captured)
    {
        ...
        return $status->modeDelegate('attrValue', 0, $status->params);
    }
